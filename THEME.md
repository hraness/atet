...
The theme lives in `apps/web/vendor/paper-theme`, `apps/desktop/frontend/vendor/paper-theme`. `provenance.json` records
...
From `apps/web`, run `bun run check:theme` to verify the snapshot offline. This is also part of
