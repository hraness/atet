export declare const vectorizeProfileNames: readonly ["balanced", "detailed", "photo"];
...
export interface VectorizeOptions {
    /**
     * Pixels below this alpha byte are removed before tracing. Graphics also
...
export type VectorizeErrorCode = "input_limit" | "invalid_input" | "output_limit" | "quality_limit" | "timeout" | "tool_download" | "tool_integrity" | "tool_platform" | "tool_version" | "trace_failed" | "unsafe_svg";
export declare class VectorizeError extends Error {
    readonly code: VectorizeErrorCode;
    readonly details: Readonly<Record<string, unknown>>;
    constructor(code: VectorizeErrorCode, message: string, details?: Readonly<Record<string, unknown>>, options?: ErrorOptions);
}
