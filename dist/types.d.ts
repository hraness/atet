export declare const diagramVersion: 1;
export type Tone = "neutral" | "blue" | "orange" | "green" | "red" | "purple" | "yellow";
...
export interface StackDiagramEdge extends Omit<DiagramEdge, "start" | "end" | "bend"> {
    readonly start?: "auto";
    readonly end?: "auto";
    readonly bend?: 0;
}
...
export interface ThemeColors {
    ...
    readonly tones: Readonly<Record<Tone, {
...
export interface PartialTheme {
    ...
    readonly muted?: string;
    readonly stroke?: string;
    readonly tones?: Partial<Record<Tone, Partial<{
        readonly fill: string;
        readonly stroke: string;
        readonly text: string;
    }>>>;
