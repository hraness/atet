...
Slopcamera currently installs from source. No renamed release archive has been published. Historical Atet archives do not install the renamed CLI; never substitute `slopcamera` into an old archive URL.
