...
# or
bunx skills add https://github.com/hraness/atet/tree/v3.0.2 --skill atet
\`\`\`
...
The public skills command installs the immutable v3.0.2 guide. When that command is not being used, \`atet skill install\` installs the guide shipped with your CLI for Codex by default.
