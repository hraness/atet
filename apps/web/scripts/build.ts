...
export async function buildWebsite(options: BuildOptions = {}): Promise<Readonly<{
  ...
  const indexAssets = {
    ...
    "{{SKILL_INSTALL_COMMAND}}": renderCopyCommand({
      alternateCommand: "bunx skills add https://github.com/hraness/atet/tree/v3.1.0 --skill atet",
      command: "npx skills add https://github.com/hraness/atet/tree/v3.1.0 --skill atet",
