...
- Render the canonical `@hraness/site-footer` markup and styles on every HTML page. Keep product links and disclosures outside the footer. Include every durable public route in crawler discovery.
