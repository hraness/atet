...
describe("static Atet site", () => {
  test("makes the README a detailed agent guide with natural GitHub discovery terms", async () => {
    ...
    expect(readme).toContain("npx skills add https://github.com/hraness/atet/tree/v3.1.0 --skill atet")
    expect(readme).toContain("bun add --global github:hraness/atet#v3.1.0")
    expect(readme).toContain("bun add github:hraness/atet#v3.1.0")
  ...
  test("puts the complete agent install before the first section ends", async () => {
    ...
    expect(html).toContain("Using Bun? <code>bunx skills add https://github.com/hraness/atet/tree/v3.1.0 --skill atet</code>")
    ...
    expect(html).toContain("github:hraness/atet#v3.1.0")
  })
  ...
  test("renders a progressively enhanced reusable copy command in the hero", async () => {
    ...
    expect(html).toContain('<code class="copy-command__value" data-copy-command-value>npx skills add https://github.com/hraness/atet/tree/v3.1.0 --skill atet</code>')
    expect(html).toContain("<code>bunx skills add https://github.com/hraness/atet/tree/v3.1.0 --skill atet</code>")
