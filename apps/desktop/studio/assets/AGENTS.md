...
- Use only the fixed Poly Haven API and asset download origins. Identify ATET in the User-Agent, reject redirects, and retain a visible Poly Haven credit independently from the CC0 asset license.
