...
export const HTML_OVERLAY_LIBRARY_LOCAL_PREFIX = "/.slopcamera-overlay/libraries/" as const;
export const HTML_OVERLAY_ASSET_LOCAL_PREFIX = "/.slopcamera-overlay/assets/" as const;
