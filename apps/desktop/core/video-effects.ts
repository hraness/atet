...
export interface CompiledVideoLook {
  readonly compiler: "slopcamera.ffmpeg-video-look";
 ...
 * Input labels, filter names, and expressions are all owned by Slopcamera.
 */
export function compileVideoLookToFfmpeg(
  ...
  return {
    compiler: "slopcamera.ffmpeg-video-look",
