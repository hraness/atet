...
const app_slug = "slopcamera";
const display_name = "Slopcamera";
const bundle_id = "com.hraness.slopcamera";
...
test "application identity is stable" {
    try std.testing.expectEqualStrings("slopcamera", app_slug);
    try std.testing.expectEqualStrings("Slopcamera", display_name);
    try std.testing.expectEqualStrings("com.hraness.slopcamera", bundle_id);
