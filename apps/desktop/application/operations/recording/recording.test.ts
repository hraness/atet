...
function controllerSnapshot(
  ...
  return {
    ...
    recordingRoot: "/private/repository/artifacts/slopcamera/recordings/rec_operation01",
    state,
  ...
  test("revalidates the workflow fence immediately before a live action", async () => {
    ...
    const context: OperationExecutionContext = {
      ...
      workflow: {
        ...
        workspaceDirectory: "/private/repository/artifacts/slopcamera/private/workflow-runs/test",
      },
    };
