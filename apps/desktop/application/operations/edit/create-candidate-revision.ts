...
export const createCandidateRevisionOperationDefinition = {
  ...
  inputSchemaId: "slopcamera.operation.edit.create-candidate-revision.input/v1",
  ...
  outputSchemaId: "slopcamera.operation.edit.create-candidate-revision.output/v1",
  policy: {
