...
private let analyzerKind = "slopcamera.face-analysis"
...
private func writeVersion(_ backend: Backend) throws {
    let line = "slopcamera-face-analyzer \(analyzerVersion) (schema \(analyzerSchemaVersion); "
...
private struct FaceAnalyzerMain {
    static func main() async {
        ...
        do {
            ...
            let diagnostic = "slopcamera-face-analyzer [\(failure.code)]: \(failure.message)\n"
