...
- Keep `slopcamera-face-analyzer` offline. It reads only the explicitly supplied local media file and never opens a network connection or loads a provider model.
