    ...
    @unchecked Sendable
{
    ...
    init(
        ...
        timingQueue = DispatchQueue(
            label: "com.hraness.slopcamera.capture.display-timing.\(display.displayID)",
            qos: .userInitiated
        )
        super.init()
...
final class CameraSegmentRecorder: @unchecked Sendable {
    ...
    private let sessionQueue = DispatchQueue(label: "com.hraness.slopcamera.capture.camera")
...
final class MicrophoneSegmentRecorder: @unchecked Sendable {
    ...
    private let interruptionReporter: CaptureInterruptionReporter
    private let interruptionMonitor: CaptureAVInterruptionMonitor
    private let sessionQueue = DispatchQueue(label: "com.hraness.slopcamera.capture.microphone")
    private let stopFlight =
