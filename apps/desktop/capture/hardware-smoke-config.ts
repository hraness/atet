export const HARDWARE_SMOKE_CONFIRMATION_ENVIRONMENT_NAME =
  "TRANSMUTE_CAPTURE_HARDWARE_CONFIRM";
...
export function hardwareSmokeRequested(
  ...
  return environment[HARDWARE_SMOKE_CONFIRMATION_ENVIRONMENT_NAME]
...
function minimumDisplaysEnvironment(
  ...
  const value = environment[HARDWARE_SMOKE_MIN_DISPLAYS_ENVIRONMENT_NAME];
...
function artifactRetentionEnvironment(
  ...
  const value =
    environment[HARDWARE_SMOKE_KEEP_ARTIFACTS_ENVIRONMENT_NAME]
    ?? "on-failure";
