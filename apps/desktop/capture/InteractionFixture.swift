...
private let interactionFixturePublicFieldIdPrefix = "slopcamera-fixture-public-"
private let interactionFixtureSecureFieldId = "slopcamera-fixture-secure"
private let interactionFixtureNeutralTargetId = "slopcamera-fixture-neutral"
...
private final class FixtureEmitter: @unchecked Sendable {
    ...
    func diagnostic(_ message: String) {
        let line = "slopcamera-capture fixture: \(bounded(message, maximumUTF8Bytes: 8_192))\n"
...
private final class InteractionFixtureRuntime {
    ...
    init(fixtureId: String) {
        ...
        windowTitle = "Slopcamera Interaction Fixture · \(fixtureId)"
    }
    ...
    private func configureApplication() {
        ...
        // Slopcamera must prove its own AX-secure redaction rather than depending
