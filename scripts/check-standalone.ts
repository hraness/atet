...
const CANONICAL_TEXT_SENTINELS = [
  {
    path: "src/version.ts",
    values: ['export const SLOPCAMERA_VERSION = "3.2.5" as const'],
  },
  {
...
} else if (packageVersion !== "3.2.5") {
  problems.push("package.json version must be 3.2.5 for this source candidate; it does not identify a published Slopcamera release");
} else {
