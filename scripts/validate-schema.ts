...
const schemaId = "https://raw.githubusercontent.com/hraness/atet/v3.2.1/schema/diagram.schema.json"
...
for (const relativePath of [
  ...
  if (!isRecord(instance) || instance.$schema !== schemaId) {
    throw new Error(`${relativePath} must reference the Atet v3.2.1 schema.`)
  }
