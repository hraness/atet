...
invariant(
  process.env.SLOPCAMERA_VTRACER_PATH === undefined,
  "Official VTracer smoke must not use SLOPCAMERA_VTRACER_PATH.",
)
...
const work = await mkdtemp(join(tmpdir(), "slopcamera-official-vtracer-"))
try {
